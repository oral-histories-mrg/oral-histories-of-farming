...
farmer-sort-name: Holland, Casey
farm: Chispas Farm
...
header-image: images/action-photo.jpg
header-title:
header-position: 0px
toc-section: first
geo: [37.88, -81.08]
...
{% include images/figure.html
  ...
  alt-text="Photo of Casey Holland"
  image-path="images/unm-camp-wallstreet.jpg"
%}
...
{% include media/audio.html
  src="audio/oral-project.mp3"
%}

{% assign images =
"images/magzine-farm.jpg,
